  ...
  const skillCategories: SkillCategory[] = [
    {
      ...
      color: "violet",
      skills: [
        { name: "React / Next.js", level: 95, color: "bg-violet-500" },
        { name: "TypeScript", level: 90, color: "bg-violet-500" },
        { name: "Tailwind CSS", level: 95, color: "bg-violet-500" },
        { name: "Vue.js", level: 85, color: "bg-violet-500" },
        { name: "Redux / Zustand", level: 88, color: "bg-violet-500" },
        { name: "HTML5 / CSS3", level: 98, color: "bg-violet-500" },
      ],
    },
    {
      id: "backend",
      ...
      color: "purple",
      skills: [
        { name: "Node.js / Express", level: 90, color: "bg-purple-500" },
        { name: "Python / Django", level: 85, color: "bg-purple-500" },
        { name: "PostgreSQL", level: 88, color: "bg-purple-500" },
        { name: "MongoDB", level: 85, color: "bg-purple-500" },
        { name: "GraphQL", level: 80, color: "bg-purple-500" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Photoshop", level: 80, color: "bg-pink-500" },
        { name: "Illustrator", level: 78, color: "bg-pink-500" },
        { name: "Prototyping", level: 90, color: "bg-pink-500" },
        { name: "UI Design", level: 93, color: "bg-pink-500" },
      ],
    },
    {
      id: "tools",
      ...
      skills: [
        ...
        { name: "AWS", level: 80, color: "bg-cyan-500" },
        { name: "CI/CD", level: 82, color: "bg-cyan-500" },
        { name: "Webpack / Vite", level: 88, color: "bg-cyan-500" },
        { name: "Linux", level: 85, color: "bg-cyan-500" },
      ],
    },
  ];
